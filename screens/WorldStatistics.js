...
const WorldStatistics = ({ navigation }) => {
  ...
  return (
    ...
    >
      ...
      <ScrollView
        style={{ paddingHorizontal: 10, flex: 1, paddingBottom: 50, paddingTop: 20 }}
      ...
      >
        ...
        >
          ...
          <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
            <View
              style={{ flex: 1, borderRightWidth: 1, borderRightColor: '#dedede', padding: 10 }}
            >
        ...
        <View style={{ marginTop: 20 }}>
          ...
          >
            ...
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              >
                <RegularText style={{ color: 'green' }}>Recovered</RegularText>
                <BoldText size="mlg">
                  {data?.country?.result?.recovered.toLocaleString() || 0}
                </BoldText>
              </View>
              <View style={{ flex: 1, padding: 10 }}>
                <RegularText style={{ color: 'red' }}>Deaths</RegularText>
                <BoldText size="mlg">
                  {data?.country?.result?.deaths.toLocaleString() || 0}
                </BoldText>
              </View>
            </View>
            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'space-between' }}>
              ...
              >
                ...
                <BoldText size="mlg">
                  {data?.country?.result?.active.toLocaleString() || 0}
                </BoldText>
              </View>
              <View
                style={{ flex: 1, borderRightWidth: 1, borderRightColor: '#dedede', padding: 10 }}
              >
                ...
                <BoldText size="mlg">
                  {data?.country?.result?.critical.toLocaleString() || 0}
                </BoldText>
              </View>
              <View style={{ flex: 1, padding: 10 }}>
          ...
          <RegularText style={{ textAlign: 'right', marginTop: 10 }}>
            Last Updated:{' '}
            {data?.globalTotal?.updated
              ? new Date(data?.globalTotal?.updated).toDateString()
              : null}
          </RegularText>
        </View>
      </ScrollView>

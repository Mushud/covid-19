    ...
    return (
        <ScrollView showsVerticalScrollIndicator={false}>
            ...
            <View style={{ marginTop: 10}}>
                <Text style={{ fontFamily: "bold", textAlign: "center", fontSize: 18}}>Last 2 countries visited</Text>
                <Text style={{ fontFamily: "regular", textAlign: "center"}}>Select the last country first</Text>
            </View>
            <View style={{ marginTop: 20}}>
                <View style={{ flexDirection: "row", justifyContent: "space-between"}}>
                    <CountryOption style={{ borderWidth: countryOne && 1, borderColor: Colors.tintColor}}>
                        <CountryPicker countryCode={countryOneCode} withFlag={true} onSelect={onCountryOneSelect} visible={false} />
                        {countryOne !== null && (
                    ...
                    <CountryOption style={{ borderWidth: countryTwo && 1, borderColor: Colors.tintColor}}>
                        <CountryPicker countryCode={countryTwoCode} withFlag={true} onSelect={onCountryTwoSelect} visible={false} />
                        {countryTwo !== null && (
            ...
            <View style={{ marginTop: 40, marginBottom: 10}}>
                <Text style={{ fontFamily: "bold", textAlign: "center", fontSize: 18}}>When did you arrive ? </Text>
                <Text style={{ fontFamily: "regular", textAlign: "center"}}>The date you arrived in Ghana</Text>
            </View>
            <FormContainer>
                <TouchableOpacity
                    activeOpacity={0.8}
                    ...
                    <View style={{ flexDirection: "row",
                        ...
                        <View style={{ flex: 9, justifyContent: "center"}}>
                            <Text style={{ fontFamily: 'regular', fontSize: 14, }}>
                                {typeof date === 'string' ? date : date.toLocaleDateString("en-US", { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}
                            </Text>
                        </View>
                        <View style={{ flex: 1, alignItems: "flex-end"}}>
                            <Ionicons style={{ marginRight: 0}} name='ios-calendar' size={24} color='#e4e4e4' />
                        </View>
                    </View>
                </TouchableOpacity>
                {
                    show && (<CustomDatePicker date={new Date()} exitOnClose={(date) => {
                        setDate(date);
                        setShow(false)
                    }} />)
                }
            ...
            <FormContainer style={{ flex: 1, flexDirection: "row", justifyContent: "space-between"}}>
                <TouchableOpacity style={{ flex: 0.48}} onPress={() => navigation.navigate("AppealScreen") }>
                    <Button
                        style={{
                            marginHorizontal: 0,
                    ...
                    >
                        <Text style={{ color: '#84b8ea', fontFamily: 'bold' }}>
                            Previous
                        </Text>
                    </Button>
                </TouchableOpacity>
                <TouchableOpacity style={{ flex: 0.48}} onPressIn={() => navigation.navigate('PersonalDetails') }>
                    <Button
                        style={{
                            marginHorizontal: 0,
                            backgroundColor: '#61e07d',
                            paddingHorizontal: 10,
                        }}
                    >
            ...
            <FormContainer style={{ marginTop: 0}}>
                <TouchableOpacity style={{ flex: 0.48}} onPressIn={() => navigation.navigate('PersonalDetails') }>
                    ...
                    >
                        <Text style={{ color: '#ff7066', fontFamily: 'bold' }}>
                            Skip
                        </Text>
                    </Button>
                </TouchableOpacity>

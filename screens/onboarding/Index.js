    ...
    <View style={{ flex: 1 }}>
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          <SimpleAnimation delay={2500} duration={1000} slide direction="up" staticType="fa">
            <Text
              style={{
                fontFamily: 'bold',
                color: '#da554b',
          ...
          <SimpleAnimation delay={3500} duration={2000} slide direction="up" staticType="fa">
            <Text
              style={{
                fontFamily: 'regular',
                fontSize: 17,
          ...
          <SimpleAnimation delay={5500} duration={2000} slide direction="up" staticType="fa">
            <Text
          ...
          <SimpleAnimation delay={7500} duration={1000} fade staticType="zoom">

      ...
      <ScrollView>
        <View style={{ paddingTop: 10, marginHorizontal: 20 }}>
          ...
          <Text style={{ fontFamily: 'regular', fontSize: 16, textAlign: 'left' }}>
            Please provide as much and as accurate information as possible to help in the fight of
            this pandemic.
          </Text>
        </View>
        <View style={{ paddingTop: 10, marginHorizontal: 20 }}>
          ...
          <Text style={{ fontFamily: 'regular', fontSize: 16, textAlign: 'left' }}>
            The information you provide is Protected by the Data Protection Laws of Ghana. It shall
            be used only for the purposes of managing COVID-19
          </Text>
        </View>

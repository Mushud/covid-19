        ...
        <ScrollView showsVerticalScrollIndicator={false}>
            <PersonalDetailsContainer>
                <View style={{ marginTop: 10, marginBottom: 20}}>
                    <Text style={{ fontFamily: "bold", textAlign: "center", fontSize: 18}}>Report a case</Text>
                    <Text style={{ fontFamily: "regular", textAlign: "center"}}>Please provide your some important details</Text>
                </View>
                <View>
                    <FormContainer>
                ...
                <View style={{ marginTop: 10}}>
                    ...
                    <Input value={location} onChangeText={setLocation} placeholder="eg. GA-492-74" keyboardType="numeric" />
                </View>

                <View style={{ flex: 1, flexDirection: 'row'}}>
                    <View style={{ marginTop: 10, flex: 0.6, marginRight: 5}}>
                        <Text style={{ fontFamily: "bold", paddingLeft: 5}}>Nearest Landmark</Text>
                        <Input value={landmark} onChangeText={setLandmark} placeholder="eg. Goil Fuel Station" />
                    </View>

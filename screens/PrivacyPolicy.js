    ...
    <View style={{ flex: 1, backgroundColor: '#ffffff', paddingBottom: 10 }}>
      ...
      >
        <View style={{ marginTop: 50, paddingHorizontal: 20, marginBottom: 0, flex: 0.9 }}>
          <BoldText size="lg">Privacy Policy</BoldText>
        </View>
      </View>
      <ScrollView style={{ paddingHorizontal: 20, flex: 1, paddingBottom: 0, paddingTop: 20}}>
        <View>
        ...
        <View style={{ marginTop: 20 }}>
          ...
          <View style={{ marginTop: 10, alignItems: 'flex-end', paddingBottom: 40 }}>
